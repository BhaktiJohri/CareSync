...
import { DoseEvent, Prescription, Medication } from '../types';
...
const HistoryPage: React.FC = () => {
  ...
  const getMedsForPrescription = (medIds: string[]) => {
        ...
        <div className="flex bg-slate-100 p-1.5 rounded-xl">
          <button
            ...
            className={`px-6 py-2.5 rounded-lg text-sm font-bold transition-all ${
              activeTab === 'doses' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'
            }`}
          >
            Dose Log
          </button>
          <button
            ...
            className={`px-6 py-2.5 rounded-lg text-sm font-bold transition-all ${
              activeTab === 'prescriptions' ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'
            }`}
          >
            Prescriptions
          </button>
